const RecipePreparing = ({recipe, slNumber, handlePreparing}) => {
    return (
        <tr className="bg-[#28282808]">
            <td className="p-1 sm:p-2 text-xs sm:text-sm">{slNumber + 1}</td>
            <td className="p-1 sm:p-2 text-xs sm:text-sm">{recipe.recipe_name}</td>
            <td className="p-1 sm:p-2 text-xs sm:text-sm">{recipe.preparing_time} min</td>
            <td className="p-1 sm:p-2 text-xs sm:text-sm">{recipe.calories} calories</td>
